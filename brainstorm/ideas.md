...
These concepts are outside the current Donut build. They have no rules authority until promoted into production.

## Physical card and information play

| Concept | Hook | Question before testing |
| --- | --- | --- |
| Stack | Overlap cards in a staircase to expose earlier ability text. | Order, active stats, damage, removal, and table space. |
| Persistent sideways card | An attackable permanent with Guard changes the board. | How to distinguish it from a Rotated card. |
| Face-down defender or modifier | Hide a card near a Leader, then reveal on Attack or first use to bluff. | Trigger, cost, public information, and response timing. |
| Inconspicuous Bush | Hide a Character underneath for a later reveal. | Visibility and counterplay. |
| Trench Coat | Stack Child Characters beneath one card. | Ownership and inspection. |
| Hot Potato | An Item moves between players or positions. | Timing and ownership. |
| Lost & Found | Store cards beneath a persistent Item. | Inspection and recovery. |
| Last Slice of Pizza | Share a physical position or Pass condition. | When and how it moves. |
| Absolutely Do Not Push This Button | A tempting persistent object changes players' incentives. | A concrete effect and opt-in cost. |
| Unofficial Reverse Card | Reverse an interaction using physical presentation. | Clear orientation and timing. |
