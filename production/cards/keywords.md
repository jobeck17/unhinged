...
| --- | --- | --- | --- |
| Hothead | This Character may Attack in the Round it enters play. | New Donut playtest keyword | P016 Porch Pirate, P018 Minibike Menace, P043 Little Leaguer, P076 Wi-Fi Bandit, P152 Florida Man's Stunt Double, P158 Patio-Table Prodigy |
| Defiant | This Character retaliates when it Blocks even if the incoming Attack Defeats it. | Renamed from the old Explosive rule; printed playtest keyword | P005 Unsupervised Toddler, P164 Stunt Clown |
...
- **Cloak:** Cloak replaces retaliation damage only. It does not protect from attack damage, Action damage, Dismiss, Return, or other non-retaliation effects. A face-down Cloaked Character remains in play, keeps its damage, orientation and attachments, and counts as a Character. It cannot Attack, Block, Activate, be chosen, take damage, or be Defeated; its printed abilities are inactive. Reveal it at end of Round before Round-limited effects expire and check Defeat when revealed.
