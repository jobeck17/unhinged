...
| --- | --- | --- | --- | --- | --- | --- |
| P031 | Character | 4 | **Wedding Cover Band** | 5/5 | Musician | — |
| P032 | Character | 2 | **Wedding DJ** | 2/3 | Musician | Rotate: One of your Characters gets +1 Power this Round, or +2 Power if it is a Musician or Clown. |
| P033 | Character | 2 | **Karaoke Champion** | 2/3 | Musician | The first time each Round you Play an Action after Playing a Character, this gets +2 Power this Round. |
...
| P054 | Action | 2 | **Everybody Bats** | — | — | Choose up to three of your Characters. Each gets +1 Power this Round. If you chose three, Draw a card. |
...
| P056 | Action | 1 | **Parking Lot Pep Talk** | — | — | A Character gets +1 Power and +2 Guard this Round. If it is a Parent, Kid, Musician, or Clown, Draw a card, then Discard a card. |
| P057 | Item | 1 | **Participation Trophy** | — | — | Attach to one of your Characters. When you Play your second card in a Round, the attached Character gets +1 Power this Round. |
| P058 | Item | 1 | **Orange Slices** | — | — | Dismiss this: Heal 2 damage from a Character, or 3 damage if you Played another card this Round. |
| P059 | Item | 2 | **Portable Bluetooth Speaker** | — | — | Rotate: One of your Characters gets +1 Power this Round. If you Played another card this Round and that Character is a Musician or Clown, it gets +2 Power instead. |
| P060 | Item | 2 | **Starter Kit** | — | — | When this enters play, Draw a card, then Discard a card. Dismiss this: The next Character costing 2 or less you Play this Round costs 1 less. |
