...
| --- | --- | --- | --- | --- | --- | --- |
| P121 | Character | 2 | **Grumpy Old Guy** | 2/4 | — | When this Blocks, the attacker gets -1 Power for this Attack. |
...
| P129 | Character | 4 | **HOA Vice President** | 4/6 | HOA | — |
| P130 | Character | 5 | **Linda From Neighborhood Watch** | 4/6 | — | When this Blocks, Draw a card, then Discard a card. Rotate: Another of your Characters gets +2 Guard this Round. |
| P131 | Character | 3 | **Old Dog** | 2/5 | Animal | When this Blocks, you may give another of your Blocking Characters +2 temporary Guard for this Attack. |
...
| P142 | Action | 2 | **I Want to Speak to Your Manager** | — | — | Return an Item to its owner's hand. If it belongs to an opponent, they Draw a card, then Discard a card. |
