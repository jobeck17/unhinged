# Florida Man vs. HOA President — test packages

Accepted for an initial test after the two card mockups; not a balance lock. Both Leaders start at **25 Health** outside their 40-card decks. Traits are unassigned and have no effect in this test.

## Shared Charge rules

Start at 0 Charge; maximum 3. Gain at most 1 Charge per Round. Retain Charge between Rounds. Gaining at the cap wastes that gain and still consumes the Round's opportunity. Spend 3 Charge as part of an ultimate's cost. Track with a marker on 0–3 or three tokens.
...
- **Bad Decisions — Charge:** When Walk It Off triggers, gain 1 Charge.
- **Hold My Entire Cooler — ultimate:** Rotate, spend 3 Charge: Choose an opposing Character or Leader. Roll a six-sided die. Deal damage equal to the result to the chosen target.
