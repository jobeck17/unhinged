...
| Leader model | Leaders are deck identity and a 25-Health target only. The Character Lab removes passives, activated abilities, Charge, rotation, and ultimates. Older Leader packages are historical experiments. | Test whether moving all memorable engines onto Characters makes turns clearer and decks more exciting. |
